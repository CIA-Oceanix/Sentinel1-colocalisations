...
def check_args(key=None, channel=None, verbose=None, sensoroperationalmode=None, platform_key=None, gif=True, max_timedelta=None, time_step=None):
    ...
    return keys, channel, verbose, sensoroperationalmode, platforms, gif, max_timedelta, time_step
