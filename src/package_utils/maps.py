...
def plot_on_map(platform, channel, data, platform_lat, platform_lon, lat_grid, lon_grid, filename, m=None, polygon=None,
                suptitle=None):
    if m is None:
        plt.figure(figsize=(12, 12))
        m = ini_map(lat_grid, lon_grid)

    kwargs, norm, colorbar_postprocess = misc.platform_cmap_args(platform, channel)
