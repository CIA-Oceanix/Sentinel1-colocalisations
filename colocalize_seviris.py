...
def main(
    ...
    for i, (filename, requested_date, polygon) in enumerate(keys):
        ...
        save_reprojection(platform, channel,closest_file_data, f'outputs/{filename}/{filename}_{platform.split(":")[1]}')
        ...
        if create_gif:
            ...
            generate_gif(
                polygon, channel, products, gif_filename, verbose, read_products, delta_factor=delta_factor, download=False
            )
